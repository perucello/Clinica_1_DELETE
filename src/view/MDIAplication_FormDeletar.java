...
public class MDIAplication_FormDeletar extends javax.swing.JFrame {


    public MDIAplication_FormDeletar() {
        initComponents();
//passo 5
...
//METODO MAIN   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDIAplication_FormDeletar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MDIAplication_FormDeletar().setVisible(true);
            }
        });
    }
