...
public class MDIAplication_FormDeletar_03 extends javax.swing.JFrame {


    public MDIAplication_FormDeletar_03() {
        initComponents();
//passo 5
    ...
    private void initComponents() {
        ...
        btnListarTodos.setBounds(490, 300, 160, 40);
        ...
        btnDeletar.setBounds(670, 300, 150, 40);
...
//passo 5 MONTAR VISUALIZAÇÃO -  AÇÃO BOTAO DELETAR
    ...
    MDIAplication_FormDeletar_01 del = new MDIAplication_FormDeletar_01();
    del.setVisible(true);
...
//METODO MAIN   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDIAplication_FormDeletar_03.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MDIAplication_FormDeletar_03().setVisible(true);
            }
        });
    }
